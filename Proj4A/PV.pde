...
void show(pt P, float r) {pushMatrix(); translate(P.x,P.y,P.z); sphereDetail(1);sphere(r); popMatrix();}; // render sphere of radius r and center P
...
pt subdiv(pt A, pt B, pt C, pt D){ return P(H(A,B,C),H(D,C,B));}
